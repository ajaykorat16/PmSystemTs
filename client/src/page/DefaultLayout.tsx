...
const DefaultLayout: React.FC = () => {
    ...
    const [birthdayUsercount, setBirthdayUsercount] = useState<number>(0);
    const [employeeCount, setEmployeeCount] = useState<number>(0);
    const [adminWorklogCount, setAdminWorklogCount] = useState<number>(0);
    const [userWorklogCount, setUserWorklogCount] = useState<number>(0);

    const fetchLeave = async () => {
        const data = await getUserLeave();
        setLeaveCount(data?.approvedLeave || 0);
    };
    ...
    if (userRole === null || userRole === undefined) {
        return (
            <Layout title='Dashboard' toast={toast}>
                <CRow>
                    <CCol sm={3}>
                        <CWidgetStatsA
                            className="mb-4"
            ...
            <CRow>
                    ...
                    {userRole === 'user' ? (
                        <CNavLink component={NavLink} to="/dashboard-user/leave/list">
                            <CWidgetStatsA
                                ...
                                chart={chart1()}
                                action={<CIcon icon={cilCalendarCheck} height={45} width={45} />}
                            />
                        </CNavLink>
                    ) : (
                        <CNavLink component={NavLink} to="/dashboard/user/list">
                            <CWidgetStatsA
                                ...
                                title="Employee"
                                chart={chart1()}
                                action={<CIcon icon={cilPeople} height={45} width={45} />}
                            />
                        </CNavLink>
                    )}
                </CCol>
                    ...
                    {userRole === 'user' ? (
                        <CNavLink component={NavLink} to="/dashboard-user/project/list">
                            <CWidgetStatsA
                                ...
                                title="My Projects"
                                chart={chart2()}
                                action={<CIcon icon={cilFolderOpen} height={45} width={45} />}
                            />
                        </CNavLink>
                    ) : (
                ...
                <CCol sm={3}>
                    <CNavLink
                        ...
                        to={
                            userRole === 'user'
                                ? '/dashboard-user/employee/birthday/list'
                                : '/dashboard/user/birthday/list'
                        }
                    >
                        <CWidgetStatsA
                            className="mb-4"
                            ...
                            chart={chart3()}
                            action={<CIcon icon={cilCalendar} height={50} width={50} />}
                        ></CWidgetStatsA>
                    </CNavLink>
                </CCol>
                <CCol sm={3}>
                    {userRole === 'user' ? (
                        <CNavLink component={NavLink} to="/dashboard-user/workLog/list">
                            <CWidgetStatsA
                                ...
                                title="Worklog"
                                chart={chart4()}
                                action={<CIcon icon={cilClock} height={45} width={45} />}
                            />
                        </CNavLink>
                    ) : (
                        <CNavLink component={NavLink} to="/dashboard/workLog/list">
                            <CWidgetStatsA
                                ...
                                title="Worklog"
                                chart={chart4()}
                                action={<CIcon icon={cilHistory} height={45} width={45} />}
                            />
                        </CNavLink>
                    )
                    }
